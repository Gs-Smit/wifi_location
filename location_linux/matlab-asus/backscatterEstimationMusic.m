function [Parameters, varargout] = backscatterEstimationMusic(csi_trace, M, N, c, fc, Ttot, ...
    fgap, SubCarrInd, d, paramRange, maxRapIters, useNoise, do_second_iter, varargin)
% INPUTS:
